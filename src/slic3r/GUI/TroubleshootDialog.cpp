    ...
    wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
{
    ...
    auto version      = new Label(this, wxString(ELEGOOSLICER_VERSION), wxALIGN_CENTRE_HORIZONTAL);
    ...
    link_report->Bind(wxEVT_LEFT_DOWN, [this](wxMouseEvent &e) {
        ...
        url += "&version="     + encodeStr(wxString(ELEGOOSLICER_VERSION));
...
{
    wxString info;
    info += "Version   :  " + wxString(ELEGOOSLICER_VERSION) + "\n"
