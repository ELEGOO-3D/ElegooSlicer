...
ZUserLogin::ZUserLogin(std::shared_ptr<ICloudServiceAgent> cloud_agent)
    : wxDialog((wxWindow*) (wxGetApp().mainframe), wxID_ANY, "ElegooSlicer"), m_cloud_agent(cloud_agent)
{
    ...
    if (!m_cloud_agent) {
        ...
        auto* m_message = new wxStaticText(this, wxID_ANY,
                                          _L("Cloud agent is not available. Please restart ElegooSlicer and try again."),
