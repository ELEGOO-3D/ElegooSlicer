    ...
    : DPIDialog(parent, wxID_ANY, _L("New version of ElegooSlicer"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX | wxRESIZE_BORDER)
{
    ...
    auto sm    = create_scaled_bitmap("ElegooSlicer", nullptr, 64);
...
void UpdateVersionDialog::update_version_info(wxString release_note, wxString version)
{
    ...
    if (is_running_in_msix())
        m_text_up_info->SetLabel(wxString::Format(_L("New version available: %s. Please update ElegooSlicer from the Microsoft Store."), version));
    else
    ...
    auto style    = "body {color:" + fg_color + "; background-color:" + bg_color + "; font-family:sans-serif}"
                  + "a    {color: #1677ff}"               // matches hyperlink colors
