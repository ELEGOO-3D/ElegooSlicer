...
void PreferencesDialog::create_items()
{
    ...
    auto item_associate_step   = create_item_checkbox(_L("Associate STEP files to ElegooSlicer"), _L("If enabled, sets ElegooSlicer as default application to open STEP files."), "associate_step");
    g_sizer->Add(item_associate_step);

    //// ASSOCIATE > WebLinks
    g_sizer->Add(create_item_title(_L("Associate web links to ElegooSlicer")), 1, wxEXPAND);
