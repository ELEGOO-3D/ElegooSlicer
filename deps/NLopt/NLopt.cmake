...
if (USE_SYSTEM_DEPS AND NLopt_FOUND)
    message(STATUS "Using system NLopt")
    set(NLopt_PKG "")
else()
    message(STATUS "Building NLopt as external project")
    elegooslicer_add_cmake_project(NLopt SHARED_LIBS_BOOL TRUE
