find_package(OpenCV QUIET COMPONENTS core imgcodecs imgproc world)

if (USE_SYSTEM_DEPS AND OpenCV_FOUND)
    message(STATUS "Using system OpenCV")
    set(OpenCV_PKG "")
else()
    message(STATUS "Building OpenCV as external project")
    if (MSVC)
    ...
    elegooslicer_add_cmake_project(OpenCV SHARED_LIBS_BOOL TRUE
