...
if (USE_SYSTEM_DEPS AND GMP_FOUND)
    message(STATUS "Using system GMP")
    set(GMP_PKG "")
else()
    message(STATUS "Building GMP as external project")
    ...
    if (MSVC)
        ...
        ExternalProject_Add(dep_GMP
            ...
            BUILD_IN_SOURCE ON
            CONFIGURE_COMMAND  env "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" ./configure ${_cross_compile_arg} --enable-shared=yes --enable-cxx=yes --enable-static=no "--prefix=${DESTDIR}" ${_gmp_build_tgt}
