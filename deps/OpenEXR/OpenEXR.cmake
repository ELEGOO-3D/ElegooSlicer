...
if (USE_SYSTEM_DEPS AND OpenEXR_FOUND)
    message(STATUS "Using system OpenEXR")
    set(OpenEXR_PKG "")
else()
    message(STATUS "Building OpenEXR as external project")
    ...
    if (APPLE AND IS_CROSS_COMPILE)
        ...
        ExternalProject_Add(dep_OpenEXR
            ...
            CMAKE_ARGS
                ...
                ${_cmake_openexr_arch}
                -DBUILD_SHARED_LIBS:BOOL=ON # Ensure shared library is built
        )
    else()
    ...
    elegooslicer_add_cmake_project(OpenEXR SHARED_LIBS_BOOL TRUE
        URL https://github.com/AcademySoftwareFoundation/openexr/archive/refs/tags/v2.5.5.zip
        URL_HASH SHA256=0307a3d7e1fa1e77e9d84d7e9a8694583fbbbfd50bdc6884e2c96b8ef6b902de
